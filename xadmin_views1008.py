    ...
    class SujectThemeDynamicForm(forms.Form):
        ...
        if (dynamicsubjectid == -1):
            ...
            for i in xrange(0, eenumnum):
                ...
                if (len(choicess[0]) != 0):
                    if (eenum[i].isMust):
                        eenumnames['eenum%s' % i] = forms.ChoiceField(
            ...
            for i in xrange(0, ttreenum):
                ...
                if (len(choicess[0]) != 0):
                    if (ttree[i].isMust):
                        ttreenames['ttree%s' % i] = forms.ChoiceField(
                            ...
                            for item in extend:
                                ...
                                if (int(SubjectTheme.objects.get(id=int(item)).fieldType) == 6 or int(
                                    ...
                                    if featureid!=None:
                                        ...
                                        print 'extendvalue,'+str(fbi.id)+','+str(item)+','+str(extend[item])
...
def swfaddr(request):
    ...
    return render_to_response("xadmin/himalaya/filebaseinfo/modifyaddr.html",
